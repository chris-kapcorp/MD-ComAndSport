		...
		<div class="main-menu">
			<nav>
				<ul class="menu">
					...
					<li><a href="<?php echo $all['page']['actualités']['slug']; ?>">Actualités</a></li>
					<li><a href="<?php echo $all['page']['partenaires']['slug']; ?>">Partenaires</a></li>
					<li><a href="<?php echo $all['page']['contact']['slug']; ?>">Contact</a></li>
				</ul>
			</nav>
		</div>
